...
public class ErrorResponseException extends Exception
		implements OneDriveSDKException
{
	private static final long serialVersionUID = -1799958534485231334L;

	@Getter
	private final int expectedResponse, givenResponse;

	@Getter
	private final String errorCode, errorMessage;

	public ErrorResponseException(int expectedResponse, int givenResponse,
			String errorCode, String errorMessage)
	{
		super(String.format(
				"Expected %d response code, but received %d. It means %s (%s).",
